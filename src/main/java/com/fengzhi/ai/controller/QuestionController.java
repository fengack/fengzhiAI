...
import com.fengzhi.ai.model.dto.question.*;
import com.fengzhi.ai.model.entity.App;
import com.fengzhi.ai.model.entity.Question;
import com.fengzhi.ai.model.entity.User;
import com.fengzhi.ai.model.vo.QuestionVO;
import com.fengzhi.ai.service.AppService;
import com.fengzhi.ai.service.QuestionService;
...
//            "应用类别，\n" +
            ...
            "\n" +
            "请你根据上述信息，按照以下步骤来出题：\n" +
            "1. 要求：题目和选项尽可能地短，题目不要包含序号，每题的选项数以我提供的为主，题目不能重复，且题目为单选题\n" +
...
//        userMessage.append("应用类别:").append(AppTypeEnum.getEnumByValue(app.getAppType()).getText()).append("\n");
        userMessage.append("要生成的题目数:").append(questionNumber).append("\n");
        userMessage.append("每个题目的选项数").append(optionNumber);
