package com.fengzhi.ai.service.impl;

import static com.fengzhi.ai.constant.UserConstant.USER_LOGIN_STATE;
...
import com.fengzhi.ai.mapper.UserMapper;
import com.fengzhi.ai.model.dto.user.UserQueryRequest;
import com.fengzhi.ai.model.entity.User;
import com.fengzhi.ai.model.enums.UserRoleEnum;
import com.fengzhi.ai.model.vo.LoginUserVO;
import com.fengzhi.ai.model.vo.UserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword,String userName) {
        ...
        synchronized (userAccount.intern()) {
            ...
            // 2. 加密
            String encryptPassword = DigestUtils.md5DigestAsHex((UserConstant.USER_PASSWORD + userPassword).getBytes());
            // 3. 插入数据
            User user = new User();
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        String userKey = UserConstant.USER_KEY + user.getId();
    ...
    public boolean userLogout(HttpServletRequest request) {
        // 移除登录态
        stringRedisTemplate.opsForHash().delete(UserConstant.USER_KEY + BaseContext.getCurrentId());
        return true;
    }
